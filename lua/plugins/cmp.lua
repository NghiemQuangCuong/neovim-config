-- This plugin is autocomplete code
return {
    {
        "L3MON4D3/LuaSnip",
        dependencies = {
    ...
    -- nvim-cmp provides auto completion and auto completion dropdown ui
    {
        ...
        config = function()
            ...
            -- Modify color of the suggestion menu
            ...
            cmp.setup({
                ...
                -- Adding some border for the suggestions 
                window = {
                    completion = cmp.config.window.bordered({
                        border = "rounded",
                        winhighlight =
                            "Normal:Pmenu,FloatBorder:CmpBorder,CursorLine:CmpSel,Search:None",
                    }),

                    documentation = cmp.config.window.bordered({
                        border = "rounded",
                        winhighlight =
                            "Normal:NormalFloat,FloatBorder:CmpDocBorder,Search:None",
                    }),
                },
            })
        end
